...
# installed.
TCL_PREFIX='c:/ml_tutorial_project/NetworkSecurity/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='c:/ml_tutorial_project/NetworkSecurity/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='c:/ml_tutorial_project/NetworkSecurity/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ic:/ml_tutorial_project/NetworkSecurity/.conda\Library\include'
...
TCL_PACKAGE_PATH='c:/ml_tutorial_project/NetworkSecurity/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lc:/ml_tutorial_project/NetworkSecurity/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='c:/ml_tutorial_project/NetworkSecurity/.conda\Library\lib\tclstub86.lib'
